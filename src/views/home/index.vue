...
const accessNum = () => {
  ...
  const myChart = echarts.init(myDom!, 'dark', { renderer: 'svg' })
  myChart.setOption({
...
<template>
  <div class="pages">
    <ul class="home_grid_container grid_list">
      ...
      <li class="item grid_item-1">
        <div class="header_info sales_num">
          <p class="name">总销售额</p>
          <h3 class="total">￥126,560</h3>
        </div>
        <div class="body_info flex aic jfs" style="height: 80px">
          <p class="info">周同比<span class="num top">12%</span><span class="icon top">↑</span></p>
          <p class="info">
            日同比<span class="num down">11%</span><span class="icon down">↓</span>
          </p>
        </div>
        <div class="footer_info">
          <p class="desc">日均销售额 <span>￥234.56</span></p>
        </div>
      </li>
      <li class="item grid_item-1">
        <div class="header_info access_num">
          <p class="name">访问量</p>
          <h3 class="total">8,846</h3>
        </div>
        <div class="body_info">
          <div id="access" style="width: 100%; height: 80px"></div>
        </div>
        <div class="footer_info">
          <p class="desc">日访问量 <span>1,234</span></p>
        </div>
      </li>
      <li class="item grid_item-1">
        <div class="header_info pay_num">
          <p class="name">支付笔数</p>
          <h3 class="total">6,560</h3>
        </div>
        <div class="body_info">
          <div id="pay" style="width: 100%; height: 80px"></div>
        </div>
        <div class="footer_info">
          <p class="desc">转化率 <span>60%</span></p>
        </div>
      </li>
      <li class="item grid_item-1">
        <div class="header_info effect_num">
          <p class="name">运营活动效果</p>
          <h3 class="total">78%</h3>
        </div>
        <div class="body_info">
          <div id="effect" style="width: 100%; height: 80px"></div>
        </div>
        <div class="footer_info">
          <p class="info">
      ...
      <li class="item grid_item-1-1 no_padding">
        <p class="title">销售额增长情况</p>
        <div class="chart_box">
          <div id="salesChart" style="width: 100%; height: 500px"></div>
        </div>
      </li>
      <li class="item grid_item-1-1 no_padding">
        <p class="title">访问增长情况</p>
        <div class="chart_box">
          <div id="addChart" style="width: 100%; height: 500px"></div>
        </div>
      </li>
      <li class="item grid_item-1 no_padding">
        <p class="title">刚刚加入的会员</p>
        <el-scrollbar class="member_list" height="540px">
          <div class="member_item flex jsb aic">
            <el-avatar
              :size="60"
            ...
            <div class="infos">
              <p class="name">史努比</p>
              <span class="desc">35分钟前加入了我们</span>
            </div>
...
.grid_list {
  ...
  .member_list {
    padding: 0 var(--el-menu-level-padding);

    .member_item {
      padding: var(--el-menu-level-padding);
      background: var(--el-bg-color);
      border-radius: var(--el-border-radius-base);
      margin: var(--el-menu-level-padding) 0;
      .infos {
